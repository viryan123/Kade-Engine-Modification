...
class Ratings
{
    ...
    public static var timingWindows = [45,90,135];

    public static function CalculateRating(note:Note, ?customSafeZone:Float):String // Generate a judgement through some timing shit
        {
            ...
            {
                if (customSafeZone <= timingWindows[Math.round(Math.min(i, timingWindows.length - 1))])
                {
